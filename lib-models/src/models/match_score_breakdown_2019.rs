...
pub struct MatchScoreBreakdown2019 {
    ...
    pub blue: Option<crate::models::MatchScoreBreakdown2019Alliance>,
    #[serde(rename = "red", skip_serializing_if = "Option::is_none")]
    pub red: Option<crate::models::MatchScoreBreakdown2019Alliance>,
}
...
impl MatchScoreBreakdown2019 {
    ...
    pub fn new() -> MatchScoreBreakdown2019 {
